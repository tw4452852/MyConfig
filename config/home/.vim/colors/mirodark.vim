...
call s:HI(      "Structure",     "", s:lmag,     "" )
call s:HI(        "Typedef",     "", s:dcyn,     "" )
call s:HI(       "Function",     "", s:lylw,     "" )
call s:HI(      "Exception",     "", s:lred,     "" )
...
call s:HI(          "Debug", "NONE", s:lred,     "" )
call s:HI(     "MatchParen", s:dwht, s:dblk,     "" )
call s:HI(       "ErrorMsg", "NONE", s:lred,     "" )
call s:HI(       "WildMenu", s:lwht, s:dmag,     "" )
call s:HI(         "Folded", s:dblk, s:dwht,     "" )
call s:HI(         "Search", s:lgrn, s:dred,     "" )
call s:HI(      "IncSearch", s:lgrn, s:dred,     "" )
call s:HI(     "WarningMsg", s:lwht, s:lred,     "" )
call s:HI(       "Question", "NONE", s:lgrn,     "" )
call s:HI(          "Pmenu", "NONE", s:lblk,     "" )
call s:HI(       "PmenuSel", s:lwht, s:lred,     "" )
call s:HI(         "Visual", s:lwht, s:lblk,     "" )
call s:HI(     "StatusLine", s:dblk, s:dwht, "none" )
call s:HI(   "StatusLineNC", s:lblk, s:dblk,     "" )
call s:HI(      "VertSplit", "NONE", s:dblk, "none" )
